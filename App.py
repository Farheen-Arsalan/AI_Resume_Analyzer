...
connection = pymysql.connect(host='localhost',user='root',password='Abcd123#',db='cv')
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Uploading your Resume...'):
                time.sleep(4)
            save_image_path = '/Users/Arsalan/Desktop/Resume/Uploaded_Resume'+pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'farsh' and ad_password == 'Abcd123#':
